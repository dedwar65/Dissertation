...
\begin{tm}
$\succsim$ satisfies AA1, AA2, C-Independence, AA3, AA4, and Uncertainty Aversion if and only if there exists a closed and convex set of probabilities on $S$, $C \subseteq \Delta(S)$, and a non-constant function $U: Y \to \mathbb{R}$ such that, for every $f, f^* \in F$,
\[
f \succsim f^*
\iff
