...
\par Since the model without heterogeneous returns is the same regardless of the distributional assumptions, in Figure 1.8 I show the results for the infinite horizon and life cycle models with heterogeneous returns, lognormally distributed across households. 
...
\par The aggregate MPC is $25.7\%$ and is nearly identical in the life-cycle setting at $26\%$. Figure 1.9 presents a breakdown of average MPCs by wealth deciles for both settings. Again, the MPC's are generally higher in the life-cycle setting due to its superior ability to match lower moments of the wealth distribution. 
...
\subsection{Mechanism for bank heterogeneity}
  ...
  \par Table 1.17 captures the estimated returns distribution that best matches the 2004 SCF data on net worth and the corresponding implied elasticities for both the infinite horizon and life-cycle settings.  
