...
\begin{figure}[H]
  ...
  \caption{Race-specific mean realized return minus the overall respondent-level mean realized return. Each respondent first contributes one average realized return to net wealth, computed over the observed panel, before the race-specific means are formed.}
