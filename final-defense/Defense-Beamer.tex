...
\begin{frame}[label=ch3-results]{Chapter 3: Ambiguity-Based Wealth Inequality}
  \begin{columns}
    ...
    \begin{center}
      \includegraphics[width=\textwidth,height=0.32\textheight,keepaspectratio]{\assetpath{ch3_measures_net_shifted.png}}\\[2pt]
      \includegraphics[width=\textwidth,height=0.32\textheight,keepaspectratio]{\assetpath{ch3_measures_gross_shifted.png}}
    \end{center}
    \vspace{0.2em}
