...
\begin{frame}[label=ch2-trustmax-deriv]{Chapter 2: Quadratic Trust Term --- Where Does the Max Come From?}
  \scriptsize
...
\begin{frame}[label=ch2-persistent]{Chapter 2: Persistent Return Component}
  \scriptsize
  $\rho\approx0.16$, $\sigma_u\approx0.16$ (persistent SD), $\sigma_e\approx0.36$ (idiosyncratic SD): roughly 16\% of total return variance reflects stable household differences, unchanged by adding portfolio-share controls.
  \vspace{0.3em}
  \begin{columns}
